      ...
      if (project && greetingOnly) {
        ...
        systemMessages.push({
          ...
          content: [
            ...
            "",
            "## Rules",
            "- Prioritize the numbered wiki pages provided below as your primary source.",
            "- If the wiki pages don't contain enough information, supplement with your own knowledge — but clearly distinguish wiki-based answers from your general knowledge.",
        ...
        {!activeConversationId ? (
          <div className="flex flex-1 items-center justify-center text-muted-foreground">
            <div className="text-center">
              ...
              <p className="mt-1 text-xs opacity-60">点击“新建对话”开始</p>
            </div>
          </div>
        ) : (
          <>
